...
GO
ALTER TABLE [dbo].[Transakcje] ALTER COLUMN [data_tran] DATE NULL;

ALTER TABLE [dbo].[Transakcje] ALTER COLUMN [kwota] MONEY NULL;

ALTER TABLE [dbo].[Transakcje] ALTER COLUMN [nr_faktury] NVARCHAR (20) NULL;

ALTER TABLE [dbo].[Transakcje] ALTER COLUMN [zaplacono] NVARCHAR (50) NULL;

ALTER TABLE [dbo].[Transakcje] ALTER COLUMN [znizka] INT NULL;
